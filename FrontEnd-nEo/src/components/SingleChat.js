...
import ProfileModeal from './miscellaneous/ProfileModeal';
...
const ENDPOINT = "http://localhost:4513"
...
const SingleChat = ({fetchAgain , setFetchAgain}) => {
    ...
    const fetchMessages = async () => {
        ...
        socket.emit("join chat", selectedChat._id);
            ...
            toast({
                title: 'Error Occured!',
                description: "Failde to Load the Search Message",
                status: 'error',
                duration: 5000,
                isClosable: true,
                position: "bottom",
    ...
    console.log(notification,"000000000000000");
            ...
            <>
                ...
                {!selectedChat.isGroupChat ? (
                    <>
                        ...
                        <ProfileModeal user={getSenderFull(user, selectedChat.users)}/>
                    </>
                ) : (
